 ...
 * @author Sara Uribe
 */
public class ClienteAhorcadito {

    protected Socket sk;
    protected DataOutputStream dos;
    protected DataInputStream dis;
    private int id;  //quiero que este id sea el nombre que ponen :(
    ...
    public ClienteAhorcadito() {
    }
    
    public ClienteAhorcadito(JTextField campoPalabra, String palabra, JLabel errores, JLabel largoPalabra) {
        ...
        this.campoErrores.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/0.jpg")));
     ...
     public void validarPalabra(char letraIngresada) {
        if (jugar) {
            ...
            if (this.intentos == 5) {
                ...
                this.campoErrores.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/6.jpg")));
                ...
                if (this.acerto == false) {
                    ...
                    campoErrores.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/" + this.intentos + ".jpg")));
     ...
     private void validarGano() {
        ...
        if (gano) {
            JOptionPane.showMessageDialog(null, "!! Felicidades !! \n Adivinaste la palabra", "Ganaste", 0, new javax.swing.ImageIcon(getClass().getResource("/Imagenes/goals.png")));
        }
    }
